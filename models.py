...
class ActorCritic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, actions_type, action_std_init, ) -> None:
        super().__init__()
    ...
    def forward(self):
        ...
        # No need for forward function in Sequential model
        pass 
...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, action_std_init=0.6):
        ...
        if has_continuous_action_space != 'discrete':
    ...
    def set_action_std(self, new_action_std):
        ...
        if self.has_continuous_action_space != 'discrete':
...
#         if has_continuous_action_space != 'discrete' and time_step % action_std_decay_freq == 0:
